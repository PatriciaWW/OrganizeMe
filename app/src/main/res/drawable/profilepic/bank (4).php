<?php
    ...
    // FUNCTIONS:
        ...
        function checkAccount() {
            global $acc, $running, $loggedin, $mainbalance, $savingsBalance, $investmentBalance, $balance, $checkaccount;
            ...
            if ($checkaccount != "m" && $checkaccount != "s" && $checkaccount != "i" && $checkaccount != "q") {
