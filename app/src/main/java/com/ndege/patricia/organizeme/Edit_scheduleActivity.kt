...
class Edit_scheduleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = prefs.getString("activity_name", "")

        ed_activity_name.setText(name)
        ed_activity_desc.setText(prefs.getString("activity_desc", ""))
        ed_start_time.setText(prefs.getString("start_time", ""))
        ed_end_time.setText(prefs.getString("end_time", ""))
        ...
        btn_add_schedule.setOnClickListener {
            ...
            val activity_id = prefs.getString("activity_id","")
            ...
            body.put("activity_id",prefs2.getString("activity_id",""))
