...
class Edit_eventsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = prefs.getString("event_name", "")

        ed_event_name.setText(name)
        ed_event_desc.setText(prefs.getString("event_desc", ""))
        ...
        btn_create_event.setOnClickListener {
            ...
            val event_id = prefs.getString("event_id","")
            ...
            body.put("event_id",prefs2.getString("event_id",""))
