...
class Edit_tasksActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val radioGroup = findViewById<RadioGroup>(R.id.task_state)

        val prefs: SharedPreferences = getSharedPreferences("storage", Context.MODE_PRIVATE)
        val name = prefs.getString("task_name", "")

        ed_task_name.setText(name)
        ed_task_desc.setText(prefs.getString("task_desc", ""))
        ed_due_date.setText(prefs.getString("due_date", ""))
        ...
        btn_add_task.setOnClickListener {
            ...
            val task_id = prefs.getString("task_id","")
            ...
            body.put("task_id",prefs2.getString("task_id",""))
